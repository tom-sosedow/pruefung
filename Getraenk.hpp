...
/**
 * Klasse für einzelne Getränke, die Eigenschaften beinhaltet, die ein Getränk formal für die 
 * Berechnungen beschreiben: Masse des Alkohols für eine bestimmte Menge an Getränk und einem bestimmten Volumenprozentanteil
 */

class Getraenk {
  public:
    /**
     * Erstellt ein Getränk mit einem bestimmten Volumenprozentgehalt und einem Volumen. Beispiel: ein typisches Bier hat 5% und wird in einem 250ml Gefäß serviert.
